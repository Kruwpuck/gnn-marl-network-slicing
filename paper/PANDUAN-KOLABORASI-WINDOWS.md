...
- **Kelas dokumen:** IEEEtran **journal**
...
Contoh & how-to IEEEtran lengkap ada di `paper\reference\`.
...
Ringkas:
- `refs.bib` sekarang cuma **1 entri placeholder** (`contoh2024`) — ganti setelah
  ada referensi asli, via **Zotero + Better BibTeX** (auto-export) atau edit manual.
